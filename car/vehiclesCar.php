...
<body>
    ...
    <div class="container" style="margin-top:95px;">
        <div class="row">
            <p style="margin-top:20px;"><strong>You can see our fleet of cars below</strong></p>
        </div>
            ...
            <?php foreach ($models as $model) { ?>
                <div class="col-lg-3 col-sm-6">
                    <div class="card mx-auto mb-4">
                        <img class="img" src="../images/car/car_models/<?php echo $model['car_image'] ?>">
                        <div class="textBox">
